...
<html lang="pt-br">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Quicksand&display=swap" rel="stylesheet">
      <title>Sistema CRUD - AG DEVELOPERS</title>
  </head>

  <body style="background: url('images/fundoAG.png');">
    <div class="container text-center" style="margin-top: 70px;">
      <form class="form-signin col-md-4 offset-md-4" method="POST" id="selectID">
        <img class="col-md-12" id="logoCarv" src="images/logoWebFlowers.png" style="height: 100%; padding: 10px 0 10px 0; margin: 0 0 25px 0; padding-left: 10px;"><br>
        <h2 class="form-signin-heading" style="font-family: 'Quicksand', sans-serif;">Sistema WebFlowers</h2><br>
    ...
    <?php 
      if(isset($_POST['usuario']) && isset($_POST['senha'])){
        ...
        if($Linha2){
          $_SESSION['usuarioId'] = $Linha2->idUsuario;
          $_SESSION['usuarioNome'] = $Linha2->usuario;

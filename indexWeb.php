    ...
    <!-- MENU -->
        <div class="col-sm-4 col-md-3 sidebar" style="position: absolute; z-index: 100; margin-top: 15px; background: transparent;" >
            ...
            <div class="list-group" id="MainMenu">
                ...
                <!-- BOTÔES MENU -->
                <a href="indexWeb.php" class="list-group-item">
                    <p class="p-menu"><i class="fas fa-home"></i> Orçamentos</p>
                </a>
                <a href="?page=consultaKits" class="list-group-item">
                    <p class="p-menu"><i class="far fa-comment-dots"></i> Nossos Kits</p>
                </a>
                <a href="?page=consultaCliente" class="list-group-item">
                    <p class="p-menu"><i class="fa fa-user"></i> Gerenciar Clientes</p>
                </a>
            </div>
        </div>
        <!-- HEADER -->
        ...
        <div class="container" style="background: transparent; border:none; padding: 15px; font-family: 'Quicksand', sans-serif; color: black;">
